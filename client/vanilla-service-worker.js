/**
 * Este es un archivo que no se utiliza debido a que la herramienta vite-plugin-pwa
 * crea un service-worker y lo registra automáticamente, pre-cacheando los archivos
 * necesarios para el funcionamiento offline, e interceptando las peticiones fetch para
 * mantener actualizada la aplicación. 
 * Se incluye aquí solo a fines de estudio y conocimiento de cómo hacerlo con vanilla javascript.
 */
